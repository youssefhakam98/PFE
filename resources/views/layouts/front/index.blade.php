                ...
                <div class="collapse navbar-collapse" id="navbars-rs-food">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            ...
                            @guest
                            <a class="nav-link" href='{{url('shwoCart/')}}'>
                                Cart [0]
                            </a>
                            {{-- Cart[0] --}}
                            @endguest
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p><a class="btn btn-lg btn-circle btn-outline-new-white"
                                    href="/reservation">Reservation</a></p>
                        </div>
                    </div>
                </div>
            </li>
                ...
                <div class="col-3">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages"
                            role="tab" aria-controls="v-pills-messages" aria-selected="false">Lunch</</a> <a
                                class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings"
                        ...
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                            ...
                            <div class="row">
                                ...
                                <div class="col -lg-4 col-md-6 special-grid drinks">
                                    <form action="{{url('/addToCard/'.$item->id)}}" method="POST">
                                        @csrf
                                        ...
                                        <input type="number" min="1" name="quantity" value="1" style="width: 120px ">
